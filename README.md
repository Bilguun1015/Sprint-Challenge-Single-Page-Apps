...
> Answer: It makes navigating through different pages faster. You can make the transition between views better.
- [ ] What does AJAX stand for?
> Answer: asynchronous JavaScript and XML
- [ ] What are `controlled components` in React?
> Answer: Component that controls the user data from form elements.
